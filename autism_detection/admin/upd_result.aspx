<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="upd_result.aspx.cs" Inherits="autism_detection.admin.WebForm29" %>
								...
								<div class="row">
									...
									<div class="col-12">
										<div class="doctor-submit text-center">
											...
											<asp:Button ID="Button2" runat="server" Text="Cancel" class="btn btn-primary submit-form me-2" />
