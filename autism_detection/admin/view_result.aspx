<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_result.aspx.cs" Inherits="autism_detection.admin.WebForm19" %>
    ...
    <div class="content">
			...
			<div class="page-header">
				<div class="row">
					<div class="col-sm-12">
						<ul class="breadcrumb">
							<li class="breadcrumb-item"><a href="patients.html">result </a></li>
...
<%--														<input type="text" class="form-control" placeholder="Search here">--%>
							...
							<asp:GridView ID="GridView1" runat="server" class="table border-0 custom-table comman-table datatable mb-0" OnRowCommand="GridView1_RowCommand">
                                <Columns>
                                    <asp:ButtonField Text="More details" CommandName="viewMore">
                                    <ControlStyle ForeColor="#3399FF" />
                                    </asp:ButtonField>
                                    <asp:ButtonField CommandName="upd" Text="Edit">
                                    <ControlStyle ForeColor="#3399FF" />
                                    </asp:ButtonField>
