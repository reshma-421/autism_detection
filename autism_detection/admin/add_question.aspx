<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="add_question.aspx.cs" Inherits="autism_detection.admin.WebForm24" %>
                        ...
                        <form action="#">
                            <div class="card-box">
                                ...
                                <div class="input-block row ">
                                    ...
                                    <div class="col-lg-9">
                                        <asp:TextBox ID="txt_qstn" runat="server" type="text" class="form-control" TextMode="MultiLine"></asp:TextBox>
                                    ...
                                    <div >
                                        ...
                                        <div class="input-block row">
                                            ...
                                            <div class="col-lg-9">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <asp:TextBox ID="txt_o1" runat="server" type="text" placeholder="Option1" class="form-control" ReadOnly="true"></asp:TextBox>
                                                    ...
                                                    <div class="col-md-6">
                                                        <asp:TextBox ID="txt_o2" runat="server" type="text" placeholder="Option2" class="form-control" ReadOnly="true"></asp:TextBox>
                                        ...
                                        <div class="input-block row">
                                         ...
                                         <div class="text-center">
                                             <asp:Button ID="Button1" runat="server" Text="Submit" type="Submit" class="btn btn-primary" OnClick="Button1_Click" />
                                             <asp:Button ID="Button2" runat="server" Text="Cancel" type="Cancel" class="btn btn-primary" CausesValidation="false" OnClick="Button2_Click" />
                                         </div>
