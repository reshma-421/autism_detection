<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="view_activity.aspx.cs" Inherits="autism_detection.admin.WebForm15" %>
...
<div class="page-header">
	<div class="row">
		<div class="col-sm-12">
			<ul class="breadcrumb">
				<li class="breadcrumb-item"><a href="doctors.html">Activity </a></li>
						...
						<div class="col">
							<div class="doctor-table-blk">
								...
								<div class="doctor-search-blk">
									...
									<div <%--class="add-group"--%>>
											<asp:Button ID="Button1" runat="server" Text="Add Activity" OnClick="Button1_Click"  CssClass="btn btn-primary ms-3"/>
