<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default2.aspx.cs" Inherits="autism_detection.exam.default2" %>
                    ...
                    function CheckIfAllQuestionAnswerHasBeenSubmitted() {  
                        ...
                        $(".tblOptions").each(function() {  
                            ...
                            if (!$("input[name='" + groupname + "']:checked").val()) {  
                                ...
                                var tableid = $(this).closest("table.tableclass").attr("id");
                            } else {  
